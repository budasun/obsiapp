...
const Community: React.FC<CommunityProps> = ({ user }) => {
    const [posts, setPosts] = useState<CommunityPost[]>(() => {
        const saved = localStorage.getItem('obsidiana_community');
    ...
    useEffect(() => {
        localStorage.setItem('obsidiana_community', JSON.stringify(posts));
    }, [posts]);
